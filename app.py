...
# Cargar modelos
MODELS = {
    "Resistencia del semento D1": joblib.load(os.path.join(MODEL_DIR, "mejor_modelo_r1_iram1622.joblib")),
    "Resistencia del semento D2": joblib.load(os.path.join(MODEL_DIR, "mejor_modelo_r2_iram1622.joblib")),
    "Resistencia del semento D3": joblib.load(os.path.join(MODEL_DIR, "mejor_modelo_r3_iram1622.joblib")),
    "Resistencia del semento D7": joblib.load(os.path.join(MODEL_DIR, "mejor_modelo_r7_iram1622.joblib")),
    "Resistencia del semento D28": joblib.load(os.path.join(MODEL_DIR, "mejor_modelo_r28_iram1622.joblib"))
}
